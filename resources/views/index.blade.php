...
<body>
  <div class="flex flex-col items-center justify-center h-screen w-full gap-y-4 p-8">
    <video class="bg-slate-100 rounded-3xl w-48 h-36" id="localVideo" playsinline autoplay muted></video>
    <video class="bg-slate-100 rounded-3xl w-full max-w-5xl h-3/4 object-cover" id="remoteVideo" playsinline autoplay></video>

    <div class="border w-full max-w-5xl py-3 px-4 rounded-3xl flex items-center justify-center gap-x-4">
      <button class="text-white bg-green-500 py-2 px-4 rounded-full" id="startButton">
      ...
      <button class="text-white bg-red-500 py-2 px-4 rounded-full" id="hangupButton">
